...
{
    public class FireLightModified : MonoBehaviour
    {
        private float m_Rnd;
        ...
        private void Update()
        {
            if (m_Burning)
            {
                m_Light.intensity = 1.2f*Mathf.PerlinNoise(m_Rnd + Time.time, m_Rnd + 1 + Time.time*1) + 1f;
                ...
                //transform.localPosition = Vector3.up + new Vector3(x, y, z)*0;
            }
        }
